    ...
    <div className="mx-auto flex flex-col gap-8 px-4 pb-4 text-black md:flex-row max-w-screen-2xl border-b border-gray-300">
      <div className='w-full md:max-w-[125px] hidden md:block'>
        ...
        <div className="flex flex-col">
          <Link className='pb-2 hover:underline text-sm' href="/">Pants</Link>
          <Link className='pb-2 hover:underline text-sm' href="/">T-Shirts</Link>
          <Link className='pb-2 hover:underline text-sm' href="/">Jackets</Link>
          <Link className='pb-2 hover:underline text-sm' href="/">Hoodies</Link>
          <Link className='pb-2 hover:underline text-sm' href="/">Shoes</Link>
        </div>
      </div>
      <div>
