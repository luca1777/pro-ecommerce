        ...
        <div className="flex flex-col lg:flex-row rounded-lg border bg-white p-8 md:p-12 lg:gap-8">
          ...
          <div className="basis-full lg:basis-2/6">
            ...
            <div>
              ...
              <div className="mx-auto font-medium mb-6">60% combed ringspun cotton/40% polyester jersey tee.</div>
              <button className="flex w-full justify-center items-center text-white p-4 rounded-full bg-blue-600 tracking-wide hover:opacity-90">Add To Cart</button>
            </div>
          </div>
        </div>
        <div className="py-8">
