  ...
  return (
    <div ref={sortRef} className='relative w-full md:max-w-[225px]'>
        ...
        <div className='absolute z-40 w-full rounded-b-md bg-white p-4 shadow-md'>
          ...
          <Link className='mt-2 flex text-sm text-black hover:underline' href="/">Price: Low to High</Link>
          <Link className='mt-2 flex text-sm text-black hover:underline' href="/">Price: High to Low</Link>
        </div>
      )}
  </div>
  )
